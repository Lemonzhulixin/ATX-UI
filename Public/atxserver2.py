...
class atxserver2(object):
    ...
    def using_device(self, udid, **kwargs):
        ...
        ret = requests.post(self._url + '/api/v1/user/devices', json={"udid": udid, "idleTimeout": 10800}, **kwargs)
...
if __name__ == '__main__':
    ...
    print(json.dumps(atxserver2(ReadConfig().get_server_url()).present_udid_devices()))